...
let MOCK_MENU = [
  ...
  { order: 4,  group: '기초 관리',   level: '2단계', name: '근무설정(정규직)',     programId: 'BS10030', sortOrder: 1030, useYn: true },
  { order: 5,  group: '기초 관리',   level: '2단계', name: '근무설정(파트타이머)', programId: 'BS10040', sortOrder: 1040, useYn: true },
  { order: 6,  group: '근태 관리',   level: '1단계', name: '근태 관리',            programId: '-',       sortOrder: 20,   useYn: true },
  { order: 7,  group: '근태 관리',   level: '2단계', name: '정규직 근태관리',      programId: 'AT10010', sortOrder: 2010, useYn: true },
  { order: 8,  group: '근태 관리',   level: '2단계', name: '파트타이머 근태관리',  programId: 'AT10020', sortOrder: 2020, useYn: true },
