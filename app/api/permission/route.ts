...
let MOCK_PERMISSIONS: Record<string, PermRow[]> = {
  시스템관리자: [
    ...
    { id: 'AT10010', name: '근태입력'   ,   access: true,  read: true,  write: true,  delete: true,  print: true },
  ...
  매장관리자: [
    ...
    { id: 'AT10010', name: '근태입력'   ,   access: true,  read: true,  write: true,  delete: false, print: true },
  ...
  일반사용자: [
    ...
    { id: 'AT10010', name: '근태입력'   ,   access: true,  read: true,  write: false, delete: false, print: false },
    { id: 'ST10010', name: '근태현황조회',       access: true,  read: true,  write: false, delete: false, print: true },
  ],
};
