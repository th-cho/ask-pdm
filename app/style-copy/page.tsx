...
const FILTER_INIT = { zone: 'OL', brand: '', year: '24', season: '5', style: '', repStyle: '', designer: '' };
    ...
    <div className="pdm-page">
      ...
      <div className="pdm-filter-bar" style={{ flexWrap: 'nowrap', gap: 6 }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 4 }}>
          ...
          <input className="form-control" style={{ width: 80 }} value={filter.designer} onChange={setF('designer')} />
          <button className="pdm-lookup-btn">?</button>
        </div>
